...
The turbine and deaerator are the same for the two systems (SGSS and MERSs), so that the corresponding state points of water are the same. The main parameters are listed in Table~\ref{tab:ptc}.
