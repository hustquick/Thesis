...
In order to study the efficiency of the system and its influencing factors, a model of the cascade system was developed. It mainly consists of the following components:
...
\subsubsection{Trough collector}
...
\subsubsection{Dish collector}
A dish reflector product of SES (Stirling Energy System) is used as the reflector, the receiver is self-designed. The key parameters of the dish collector are listed in Table~\ref{tab:DishCollectorParameters}. 
...
\begin{table}[htbp]
	...
	\end{tabular}
	\end{center}
	\label{tab:DishCollectorParameters}
\end{table}

\subsubsection{Stirling engines}
The Stirling engines used in the cascade system are the same with the one analyzed in section~\ref{sec:StirlingEngineModel}. It is the GPU-3 Stirling engine, Table~\ref{tab:GPU3parameters} shows its parameters.
