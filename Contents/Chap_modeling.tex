...
完成各部件的数学机理研究和运行特征分析后，利用MATLAB的数学计算和建模分析等功能，采用面向对象的方式，以运行库文件和各模型基础模块为基础，编写开发系统的主程序，建立了具有软件著作权的太阳能光热发电开发系统。图\ref{fig:SystemFlow}是太阳能光热发电开发系统结构图。该开发系统具有系统部件选择、部件模型选择、部件连接、设定系统参数、模拟计算、结果分析等功能。
