...
\enabstract
{
    With the increasing awareness of problem of fossil energy consumption and environmental pollution, solar energy as a renewable energy, which has the advantages of widely spreeded, huge amount, inexhaustible and no pollution, has received much attention by many countries and been regarded as the greated potential candidate of the fossil energy. Concentrated solar thermal power generation is another form of power generation technology except solar photovoltaic power generation. Compared to solar photovoltaic, solar thermal power is gaining more attention for its advantages as smooth power generation, good grid compatibility, easy to combinate with existing fossil power plant.

    Commercial solar thermal power generation technology is divided into trough-type collector power generation, disc-type power generation and tower collector three collector power generation. Three types of power generation technologies have their own advantages and disadvantages: trough type collector power generation is the most widely used, the cost is low, but the efficiency is low; disc collector power generation is smaller, more for distributed generation; Large, high cost, is currently in rapid development stage. Based on the idea of ​​energy cascade collection and energy cascade utilization, this paper proposes a cascade system which adopts a variety of collector power generation methods, which is a new and feasible technology to realize large-scale solar thermal power generation. Program.

        The objective of this project is to study the advantages and shortcomings of solar photovoltaic power generation system, and the thermal characteristics of solar thermal power generation system, and to study the advantages and disadvantages of the solar thermal power generation system. In this paper, the research of solar thermal cascade generation system, The solar cascade power generation system was proposed and optimized, and a new scheme was proposed to explore the solar thermal power generation technology which could utilize solar energy on a large scale. The main contents and conclusions are as follows:

        Firstly, a mechanism model is established for each part of solar thermal cascade power generation system. According to the operation mechanism of the target object, the mathematical model is established according to the physical balance equation, especially the key components in the system, such as collector, steam generating system, steam turbine and Stirling machine. The mathematical model of each component is a model verified by the classical theory or a large number of experimental data, which is the basis of the model of the cascade solar thermal power generation system. The heat loss model is established for the collector of the collector and the collector of the disk collector. For the Stirling machine, based on the reasonable simplification and hypothesis, the heat transfer model of the Stirling machine based on isothermal heat transfer is deduced. Machine model. The component model is written in MATLAB language and adopts the object - oriented method. It makes full use of inheritance and polymorphism to ensure the independence and relevance of the components.

        Secondly, the topological structure of solar thermal cascade power generation system is proposed. According to the analysis of thermal characteristics and the working characteristics of each component in the system, a solar thermal cascade thermal power generation system is rationally arranged to realize the cascade utilization of energy of different grades by using different thermal power cycle. A reasonable cascade generation system can make full use of the mechanism model of the power generation system and provide the foundation for the creation of high efficiency solar thermal cascade generation system. In this paper, a set of feasible topological structure of cascade heat collecting system is set up according to the mechanism model of each component. After the system evaluation, parameter selection, preliminary calculation and comparison of the two schemes, two typical schemes of solar thermal cascade generation system were determined. A program at the same time the use of water quality Rankine cycle and Stirling cycle, the use of water to cool the Stirling machine cold chamber, recycling Stirling machine heat released; another program using multi-level organic work Rankine Circulation, the use of a heat on the next level of condensation heat to the next cycle of work, to achieve the cascade use of energy.
