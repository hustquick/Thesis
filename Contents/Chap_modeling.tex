...
Evaluation of the developed thermal model is performed by considering the GPU-3 Stirling engine as a case study. Design specifications of the GPU-3 Stirling engine are indicated in \autoref{tab:GPU3parameters}. The thermal efficiency and power of the proposed Stirling engine model are compared with previous thermal models and experimental data as shown in \autoref{tab:EfficiencyComparison} and \autoref{tab:PowerComparison}.
