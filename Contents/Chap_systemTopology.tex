...
太阳能烟囱也被称为太阳能气流电站，直接（不聚光）利用太阳产生的热能来发电。太阳能烟囱发电系统由太阳能集热棚、太阳能烟囱和涡轮机发电机组3个基本部分所构成，图\ref{fig:SolarChimney}显示了一个典型的太阳能烟囱发电厂的示意图。 在这种植物中，空气在半透明屋顶下被温室效应加热。 由于屋顶在周边是开放的，由于密度分布不同，空气流入工厂。 由于浮力，热空气流入烟囱。 在气流路径上设置发电涡轮，将气流动能转化为电能。
