...
\begin{enumerate}
  ...
  The outlet of the heated fluid is saturated liquid ($x = 0$), so the outlet temperature $T_{2i}$ and outlet enthalpy $h_{2i}$ of the heated fluid is determined by pressure $p_s$.
  \begin{equation}
...
\end{equation}
  ...
  The outlet of the heated fluid is saturated gas ($x = 1$), so the outlet temperature $T_{2j}$ and outlet enthalpy $h_{2j}$ of the heated fluid is determined by pressure $p_s$.
  \begin{equation}
...
\subsubsection{Steam Rankine cycle}
  ...
  Figure~\ref{fig:T-s_Water} shows the $T-s$ diagram of the water circuit in the cascade system.Figure~\ref{fig:SteamTurbine_hs} shows the heat process curve of the steam turbine in fig~\ref{fig:PES}. To simplify the inner process of the turbine, same isentropic efficiency of steam turbine with different loads and in different stages is assumed, which means  
  \begin{equation}
...
\begin{subfigure}[b]{0.35\columnwidth}
	...
	\caption{$h-s$ diagram of the process $2a$-$2b$}\label{fig:SteamTurbine_hs}
	\end{subfigure}
	
	\caption{$T-s$ diagram of the water circuit and $h-s$ diagram of the process $2a$-$2b$}\label{fig:SteamTurbine_hs}
\end{figure}
...
\end{equation}
  ...
  \subsubsection{ORC turbine}
  
  For organic Rankine cycle, since the pressure of the working fluid is always has than that of the atmosphere, there is no air leakage. This means a deaerator is no more
necessary. The turbine is without extraction. Since the 

Figure~\ref{fig:ORCsystem1} shows the schematic diagram of an ORC system without regenerator.
...
\noindent \begin{figure}[htbp]
\begin{center}
	\includegraphics[width = 0.4\columnwidth]{fig/stirlingEngineArray.pdf}
